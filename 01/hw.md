# Домашнее задание к занятию «Введение в Terraform» - Семикова Т.В. FOPS-9
...
4. Скачайте на свой ПК этот git-репозиторий. Исходный код для выполнения задания расположен в директории **01/src**.
